...
test('resolveExpression "(1-1)/0" should throw InvalidOperationError', function () {
    expect(function () {
...
test('sum "--1+1" should throw InvalidOperationError', function () {
    expect(function () {
        console.log(calculations_module_1.CalculationsModule.sum('--1+1'));
    }).toThrow(/Invalid Operation/);
});
test('sum "--1" should throw InvalidOperationError', function () {
    expect(function () {
...
test('sum "2*1+1" should throw InvalidOperationError', function () {
    expect(function () {
...
test('divide "0/0" should throw InvalidOperationError', function () {
    expect(function () {
